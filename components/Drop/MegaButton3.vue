<template>
  <li>
    <button id="mega-menu-dropdown-3" data-dropdown-toggle="mega-menu-3"
      ...
      Студентам <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
        viewBox="0 0 10 6">
