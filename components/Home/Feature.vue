...
<div class="max-w-7xl mx-auto font-[sans-serif] text-[#333] my-[10rem]">
      ...
      <div class="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 gap-x-12 gap-y-20 mt-16">
        ...
        <div class="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-4 inline-block bg-blue-100 p-3 rounded-xl" viewBox="0 0 682.667 682.667">
            <defs>
        ...
        <div class="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-4 inline-block bg-blue-100 p-3 rounded-xl" viewBox="0 0 512.001 512.001">
        ...
        <div class="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-4 inline-block bg-blue-100 p-3 rounded-xl" viewBox="0 0 24 24">
        ...
        <div class="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-4 inline-block bg-blue-100 p-3 rounded-xl" viewBox="0 0 504.69 504.69">
        ...
        <div class="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-4 inline-block bg-blue-100 p-3 rounded-xl" viewBox="0 0 512 512">
          ...
          <p class="text-gray-500 text-sm">Seamlessly integrate with your existing tools and systems.</p>
          <a href="javascript:void(0);" class="text-blue-600 font-bold inline-block text-sm mt-2 hover:underline">Learn more</a>
        </div>
        <div class="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-4 inline-block bg-blue-100 p-3 rounded-xl" viewBox="0 0 32 32">
          ...
          <p class="text-gray-500 text-sm">Easily scale your resources to meet growing demands.</p>
          <a href="javascript:void(0);" class="text-blue-600 font-bold inline-block text-sm mt-2 hover:underline">Learn more</a>
        </div>
      </div>
    </div>
